...
export default function catalyst_profiling() {
...
function onclickback(){
    ...
    <div style={{ textDecoration: "none", marginTop:'650px',padding:'30px', justifyContent:'center',alignItems:'flex-end',display:'flex'}}>
    <NavLink to={qnumber?"/catalyst_profiling":"/starting_page"} style={{ textDecoration: "none"}}>
