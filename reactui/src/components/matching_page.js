...
export default function matching_page() {
    return(
        <div class="matching_page">
            ...
            <div class="match_user">
              ...
              <Avatar style={{display:"flex", width:"200px",height:"200px",backgroundColor:'gray'}} alt="Remy Sharp" src="/static/images/avatar/2.jpg" />
